...
test("TodoPlásticos conserva su Umami Agama cuando faltan variables de build", async () => {
...
test("TodoPlásticos no acepta por error el VPS personal", async () => {
...
test("un ID parcial o residual no sustituye el sitio público de TodoPlásticos", () => {
  expect(resolvePublicUmamiConfig({
