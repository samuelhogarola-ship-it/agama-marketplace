...
async function seedAgamaSampleListing() {
  ...
  const company = {
    ...
    description: "Empresa ficticia usada como modelo de anuncio para TodoPlásticos. Publica productos plasticos permitidos con informacion clara, contacto externo y enlace propio.",
