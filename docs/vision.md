# Visión — AGAMA Marketplace

## La idea en una frase

Un marketplace vertical B2B donde los proveedores de productos de plástico de Ciudad de México publican su catálogo, los compradores los encuentran, y AGAMA se convierte en el punto de paso obligado del sector — ganando marca y datos.

## Por qué

1. **Visibilidad de marca:** cada proveedor y comprador del sector plástico en CDMX conoce a AGAMA.
...
3. **Monetización futura:** suscripción Pro, destacados, publicidad del sector.
...
- **Comprador:** puede navegar sin cuenta; necesita cuenta (también profesional) para contactar por mensajería.
...
6. Mensajería interna comprador ↔ vendedor con notificación por email.
7. Watcher IA: modera cada publicación (texto + imágenes) y cada mensaje. Ver [moderacion-ia.md](moderacion-ia.md).
